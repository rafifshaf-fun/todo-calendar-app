-- Demo User + 31 Tasks Seed
-- Run this in Supabase SQL Editor: https://supabase.com/dashboard/project/sjvjjbjyswazbsiseuim/sql/new

-- 1. Create demo user (password: password123)
...
-- 2. Delete existing demo tasks (if any) and insert fresh
