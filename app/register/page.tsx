...
export default function RegisterPage() {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      {/* ── Left brand panel ── */}
      <div className="relative hidden lg:flex lg:w-1/2 flex-col justify-between p-12 overflow-hidden bg-gradient-to-br from-violet-600 via-primary-700 to-primary-600">
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute -top-24 -right-24 h-96 w-96 rounded-full bg-white/5" />
          <div className="absolute bottom-0 left-0 h-80 w-80 rounded-full bg-primary-400/20" />
        </div>
        ...
        <div className="relative space-y-6">
          <h2 className="text-3xl font-bold text-white leading-snug">
            Start organized.<br />Stay productive.
          </h2>
